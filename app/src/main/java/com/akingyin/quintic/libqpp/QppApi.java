 ...
 *
 */
package com.akingyin.quintic.libqpp;
...
public class QppApi {
  ...
  public static boolean qppEnable(BluetoothGatt bluetoothGatt, String qppServiceUUID,
  ...
  public static boolean setQppNextNotify(BluetoothGatt bluetoothGatt, boolean EnableNotifyChara) {
    ...
    return setCharacteristicNotification(bluetoothGatt, arrayNtfCharList.get(notifyCharaIndex++),
        EnableNotifyChara);
  }
