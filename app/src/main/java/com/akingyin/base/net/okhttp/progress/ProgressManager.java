...
import com.akingyin.base.net.okhttp.progress.body.ProgressRequestBody;
import com.akingyin.base.net.okhttp.progress.body.ProgressResponseBody;
...
public final class ProgressManager {
  ...
  /**
   * 设置 {@link ProgressListener#} 每次被调用的间隔时间
   *
